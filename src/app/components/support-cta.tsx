    ...
    <section id="destek" className="mx-auto max-w-7xl px-5 py-24 sm:px-8">
      ...
      >
        ...
        <div className="relative mb-9 flex flex-col gap-4 border-b border-white/10 pb-7 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2 text-[9px] font-black uppercase tracking-wider"><span className="rounded-full border border-emerald-400/20 bg-emerald-400/8 px-3 py-2 text-emerald-300">● Hatlar açık</span><span className="rounded-full border border-white/10 bg-white/5 px-3 py-2 text-white/60">Antakya merkez</span><span className="rounded-full border border-cyan-300/15 bg-cyan-300/5 px-3 py-2 text-cyan-200">AVC kayıtlı</span></div>
        </div>
        ...
        <div className="relative grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-7 gap-y-3 text-[12px] text-white/60"><span className="flex items-center gap-2"><Clock className="h-4 w-4 text-[#3ec8dc]" /> Hafta içi 10:00–18:00</span><span className="flex items-center gap-2"><MapPinned className="h-4 w-4 text-[#3ec8dc]" /> Antakya / Hatay</span></div>
          </div>
