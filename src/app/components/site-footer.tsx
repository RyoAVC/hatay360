  ...
  return (
    <footer className="mt-16 border-t border-white/10 bg-[#061820] text-white">
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-7 text-[11px] text-white/35 sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} {settings.siteTitle || "Hatay360"}. Tüm hakları saklıdır.</p><p>AVC Dijital Ekosistemi içinde kayıtlı projedir.</p></div>
      </div>
    </footer>
  );
}
